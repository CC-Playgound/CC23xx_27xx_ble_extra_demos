...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        基于basic_ble例程 peripheral 角色添加以下功能：
        <ul>
          <li>定时发送参数更新请求</li>
          <li>关闭CSA#2(或其它LE feature set)</li>
          <li>通过连接事件回调获取RSSI</li>
        </ul>
        基于 basic_ble 例程 central 角色添加以下功能：
        <ul>
    ...
    <tr>
      <td>ext_led_control</td>
      <td>LP-EM-CC2340R53</td>
      <td>使用 LGPTimer 作为主 MCU 控制外部 LED driver 的 bit1 和 bit0 </td>
    </tr>
    <tr>
